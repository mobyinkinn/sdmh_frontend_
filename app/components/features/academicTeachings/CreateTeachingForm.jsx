...
import { useCreateTeaching } from "../../admin/academic_teachings/useTeachings";
import { Stack } from "@mui/material";
import SpinnerMini from "../../ui/SpinnerMini";
import { useDepartment } from "../../admin/departments/parts/useDepartment";
import styled from "styled-components";

function CreateTeachingForm({ cabinToEdit = {}, onCloseModal }) {
  ...
  const { isCreating, createTeaching } = useCreateTeaching();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button disabled={isWorking}>{"Create new teaching"}</Button>
      </Stack>
    </Form>
  );
}

export default CreateTeachingForm;
